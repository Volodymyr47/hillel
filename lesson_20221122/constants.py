...
EXCEPTION_MASSAGE = 'Entered value is wrong.\nBy default you will repeat 3 (three) times'
ASK_COUNT_ITERATION = 'There will be at least one iteration.\n' \
                      'How many times do you plan to play? ' \
                      '(type only integer value, e.g. 2, 3, 5 etc. Default - 3): '
